...
public class FormTask extends JFrame implements ActionListener {
    ...
    private void submitBtnPress() {
    	...
    	/*
         * Include a "lock" or rather a progress bar
         * until it is confirmed that the data has been correctly sent to 
         * the receiver app 
        */
        tout.setText(
            "\n  Employee id : "
        ...
        String responseText = "Waiting for confirmation";          	
        res.setText(responseText); 
